...
`spring-boot-starter-aop` is `spring-boot-starter-aspectj` now. `spring-boot-starter-undertow` does not exist at any version — Boot 4 dropped Undertow because it does not implement Servlet 6.1.
